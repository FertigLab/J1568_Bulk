...
JOB_SCRIPT="scripts/20220627_domino_Steele_immune.sh"
...
# the steps with pyscenic completed sucessfully on 06/28/2022, but an error in the filename
# in the R script caused an error that did not generate the domino object. This script skips
# the pyscenic steps because they are already complete, and resumes the job at the R steps
